...
public class Maze {
	 ...
	 public void GenerateWalls()
	 {
				...
				while(Welldown<length*width-1) {
					...
					if (CoordinateList2D[randomrow][randomcol]!=CoordinateList2D[randomrow+1][randomcol]&&
						...
						CoordinateList2D[randomrow+1][randomcol]=CoordinateList2D[randomrow][randomcol];
							//knock down the up wall of randomrow+1 and south wall of randomrow(same)
				...
				if (CoordinateList2D[randomrow][randomcol]!=CoordinateList2D[randomrow-1][randomcol]&&
						right[randomrow-1][randomcol]==true&&left[randomrow][randomcol]==true) {
					CoordinateList2D[randomrow-1][randomcol]=CoordinateList2D[randomrow][randomcol];
				//knock down the right wall of randomrow-1 and left wall of randomrow(same)
				right[randomrow-1][randomcol]=false;
				left[randomrow][randomcol]=false;					
						Welldown++;}
						}
				
				if (randomdir==3&&randomrow-1>=0) {
				if (CoordinateList2D[randomrow-1][randomcol]!=CoordinateList2D[randomrow][randomcol]&&
